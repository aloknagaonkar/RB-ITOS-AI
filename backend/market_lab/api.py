...
from .hilega_directional_candle_ui_v1 import router as hilega_directional_candle_router
from .hilega_directional_historical_ui_v1 import router as hilega_directional_historical_router
...
from .live_fixed_session_ui_projection_v1 import attach_fixed_session_trends, load_fixed_anchor_index, project_fixed_session_ui
...
def create_app(engine=None, historical_gateway_factory=None):
    ...
    app.include_router(hilega_directional_candle_router)
    app.include_router(hilega_directional_historical_router)
