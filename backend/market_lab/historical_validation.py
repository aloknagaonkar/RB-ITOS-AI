...
from .domain import HistoricalCandle, HistoricalOptionContract
...
def validate_historical_session(
    ...
    return HistoricalSessionValidationReport(
        ...
        first_valid_moving_pcr=point(moving_available[0]) if moving_available else None,
        last_valid_moving_pcr=point(moving_available[-1]) if moving_available else None,
        timestamp_gaps=gaps,
