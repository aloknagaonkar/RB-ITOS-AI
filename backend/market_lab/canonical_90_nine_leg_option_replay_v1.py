...
MODEL = "CANONICAL_90_NINE_LEG_OPTION_REPLAY_V1"
...
def run(
    *,
    ...
    ready = [
        ...
        if r.get("coverage_status") == "READY"
    ]
    censored = [
        r for r in coverage["legs"]
    ...
    result = {
        "status": "PASS",
        "model": MODEL,
        "role": "DESCRIPTIVE_NINE_LEG_REPLAY_ON_EXPOSED_CANONICAL_90_POPULATION",
        ...
        "common_complete_signal_comparison": {
            ...
            "note": (
                "Strike comparison uses only signals for which all nine legs are "
