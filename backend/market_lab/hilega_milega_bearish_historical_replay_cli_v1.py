...
from .hilega_milega_bearish_historical_replay_v1 import (
    UNDERLYING,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="python -m market_lab.hilega_milega_bearish_historical_replay_cli_v1"
    )
    ...
    parser.add_argument(
        "--output-root",
        default="data/historical-evidence/hilega-milega-bearish-replay-v1",
    )
