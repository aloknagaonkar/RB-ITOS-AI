...
def build_audit(date: str, positioning_file: Path, futures_csv: Path, option_ohlc_file: Path | None = None, strike_step: float = 50.0, wings: int = 5, labels: list[LabelRange] | None = None, strategy_events_json: Path | None = None):
    ...
    for ts in cps:
        ...
        rows.append({
            ...
            "ce_oi":ce,"pe_oi":pe,
            "ce_oi_previous_same_strikes_5m":pce5,"pe_oi_previous_same_strikes_5m":ppe5,
            "ce_delta_5m":ce_d,"pe_delta_5m":pe_d,"imbalance_5m":imb,"imbalance_sign":sign(imb),
            "ce_oi_previous_same_strikes_10m":prev_same[10][0],"pe_oi_previous_same_strikes_10m":prev_same[10][1],
            "ce_delta_10m":ce_d10,"pe_delta_10m":pe_d10,"imbalance_10m":imb10,
            "ce_oi_previous_same_strikes_15m":prev_same[15][0],"pe_oi_previous_same_strikes_15m":prev_same[15][1],
            ...
            "morning_fixed_atm":morning_atm,"fixed_strikes":",".join(str(int(x)) for x in fixed_strikes),
            "fixed_ce_oi_baseline_0920":base_ce,"fixed_pe_oi_baseline_0920":base_pe,
