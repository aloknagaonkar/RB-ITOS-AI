...
def _chain(call_ltp, call_oi, put_ltp, put_oi, strike=25000):
    return pd.DataFrame([{
        "strike": strike, "call_ltp": call_ltp, "call_oi": call_oi, "call_volume": 120000,
        "put_ltp": put_ltp, "put_oi": put_oi, "put_volume": 110000,
    }])
...
def test_rotation_is_descriptive():
    prev = pd.DataFrame([
    ...
    result = StrikeRotationEngine.evaluate(cur, prev)
