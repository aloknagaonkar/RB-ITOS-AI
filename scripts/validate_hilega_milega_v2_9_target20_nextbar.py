...
def main():
    ...
    ap.add_argument("--output-dir", default="data/historical-evidence/branch-c-v2-9-target20-nextbar")
    ...
    write_csv(out / "branch-c-v2-9-target20-regimes.csv", regime_rows)
    write_csv(out / "branch-c-v2-9-target20-daywise.csv", day_rows)
    write_csv(out / "branch-c-v2-9-target20-events.csv", event_rows)
    ...
    (out / "branch-c-v2-9-target20-summary.json").write_text(
    ...
    print("\nOutputs:")
    print(out / "branch-c-v2-9-target20-daywise.csv")
    print(out / "branch-c-v2-9-target20-regimes.csv")
    print(out / "branch-c-v2-9-target20-events.csv")
    print(out / "branch-c-v2-9-target20-summary.json")
