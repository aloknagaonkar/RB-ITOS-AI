...
def main():
    ...
    ap.add_argument("--output-dir", default="data/historical-evidence/branch-c-v2-8-path1-only")
    ...
    write_csv(out / "branch-c-v2-8-regimes-daywise.csv", regime_rows)
    write_csv(out / "branch-c-v2-8-daywise-source-separation.csv", day_rows)
    write_csv(out / "branch-c-v2-8-events.csv", event_rows)
    ...
    summary = {
        "model": "BRANCH_C_HILEGA_MILEGA_V2_8_PATH1_ONLY",
        "sessions": len(target),
    ...
    (out / "branch-c-v2-8-summary.json").write_text(
    ...
    print("\nOutputs:")
    print(out / "branch-c-v2-8-daywise-source-separation.csv")
    print(out / "branch-c-v2-8-regimes-daywise.csv")
    print(out / "branch-c-v2-8-events.csv")
    print(out / "branch-c-v2-8-summary.json")
