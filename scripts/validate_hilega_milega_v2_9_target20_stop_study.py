...
def main():
    ...
    ap.add_argument("--output-dir", default="data/historical-evidence/branch-c-v2-9-target20-stop-study")
    ...
    write_csv(out / "branch-c-v2-9-target20-stop-study-regimes.csv", regime_rows)
    write_csv(out / "branch-c-v2-9-target20-stop-study-daywise.csv", day_rows)
    write_csv(out / "branch-c-v2-9-target20-stop-study-events.csv", event_rows)
    ...
    (out / "branch-c-v2-9-target20-stop-study-summary.json").write_text(
    ...
    print("\nOutputs:")
    print(out / "branch-c-v2-9-target20-stop-study-daywise.csv")
    print(out / "branch-c-v2-9-target20-stop-study-regimes.csv")
    print(out / "branch-c-v2-9-target20-stop-study-events.csv")
    print(out / "branch-c-v2-9-target20-stop-study-summary.json")
