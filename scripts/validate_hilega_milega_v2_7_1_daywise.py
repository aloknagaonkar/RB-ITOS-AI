...
def fetch_1m(token,sd):
    # Reuse the repository provider boundary instead of raw urllib.
    # Raw urllib requests were blocked by Upstox/Cloudflare Error 1010
    # because of the client's browser signature.
