...
class StrikeRotationResult:
    ...
    def as_dict(self) -> dict[str, object]:
        return {
            "Call Center Previous": self.call_center_previous,
            "Call Center Current": self.call_center_current,
            "Put Center Previous": self.put_center_previous,
            "Put Center Current": self.put_center_current,
            "Call Shift": self.call_shift_points,
            "Put Shift": self.put_shift_points,
            "Rotation": self.state,
            "Rotation Confidence %": self.confidence_pct,
        }


class StrikeRotationEngine:
    """Detect where option OI concentration migrates between snapshots."""
