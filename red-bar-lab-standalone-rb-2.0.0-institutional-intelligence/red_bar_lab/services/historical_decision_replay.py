...
class DecisionReplayRow:
    ...
    trailing_protected_points: float | None = None
    reversal_state: str | None = None
    reversal_reason: str | None = None
    reversal_provisional: bool = False
    reversal_confirmed: bool = False
    reversal_ema10_value: float | None = None
    reversal_ema10_slope: float | None = None
    reversal_ema10_ok: bool | None = None
    reversal_ema30_value: float | None = None
    reversal_ema30_slope: float | None = None
    reversal_ema30_ok: bool | None = None
    reversal_two_directional_closes: bool | None = None
    reversal_momentum_ok: bool | None = None
    reversal_active_invalidation: float | None = None
    reversal_invalidation_broken: bool | None = None
    reset_rebreak_reason: str | None = None
    reset_seen: bool | None = None
    reexpansion_detected: bool | None = None
    reset_candle_time: object | None = None
    ema10_touch_detected: bool | None = None
    reexpansion_break_level: float | None = None
    strong_expansion_candle: bool | None = None
    reset_classification: str | None = None
    reset_window_bars: int | None = None
    reset_counter_candle_seen: bool | None = None
    reset_near_touch_detected: bool | None = None
    shallow_reset_detected: bool | None = None
    reset_quality_passed: bool | None = None
    reset_quality_criteria_count: int | None = None
    reset_quality_criteria: str | None = None
    reset_market_action_count: int | None = None
    reset_market_action_passed: bool | None = None
    reset_market_action_criteria: str | None = None
    reset_moderate_market_action_passed: bool | None = None
    reset_market_action_tier: str | None = None
    reset_body_ratio_pct: float | None = None
    reset_move_beyond_break_pct: float | None = None
    reset_relative_volume: float | None = None
    quality_candidate_score_input: float | None = None
    quality_opportunity_health_input: float | None = None
    adaptive_initial_stop_pct: float | None = None
    adaptive_trailing_exit_price: float | None = None
    adaptive_trailing_return_pct: float | None = None
    adaptive_trailing_exit_reason: str | None = None
    adaptive_trailing_protected_points: float | None = None
